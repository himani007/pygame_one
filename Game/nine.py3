...
# adding sound effect and more collision..
...
#-----if i want to add sound------while shooting bullet.. create a variable bulletSound = pygame.mixer.Sound('name of sound') and to play it just mention bulletSound.play()-------

#adding music throughout the game...
music = pygame.mixer.music.load('music.mp3')
pygame.mixer.music.play(-1) #-1 will keep the song going.
...
#when my player collides with the enemy
	def player_hit(self):
		self.x = 60
		self.y = 410
		self.walkCount = 0
		font_variable2 = pygame.font.SysFont('comicsans',100, False, True)
		text = font_variable2.render('-10',1,(255,0,0))
		win.blit(text, ((250-(text.get_width()/2)),250))
		pygame.display.update()
		#to make text stay on screen for some time
		i = 0
		while i<100:
...
while run:
	...
	if (gameChar.hitbox[1] < enemy_1.hitbox[1]+enemy_1.hitbox[3]) and  (gameChar.hitbox[1]+gameChar.hitbox[3] > enemy_1.hitbox[1]):
		if gameChar.hitbox[0] + gameChar.hitbox[2] > enemy_1.hitbox[0] and (gameChar.hitbox[0] - gameChar.hitbox[2] < enemy_1.hitbox[0] + enemy_1.hitbox[2]):
			gameChar.player_hit()
			score -=10	
